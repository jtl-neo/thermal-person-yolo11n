...
📊 **線上視覺報告（微調 vs 原版 YOLO11n 並排對比）**：https://claude.ai/code/artifact/2f0c522e-dbc3-4e6f-9a16-15ca03004f39

> Test set（2577 圖 / 7426 person）：mAP50 **0.949** / mAP50-95 **0.615**，對比原版 COCO yolo11n 的 0.563 —— recall 從 0.474 拉到 0.881（漏抓率 53% → 12%）。
